import { useAddress, useContract, Web3Button } from "@web3sdks/react";
...
export default function Home() {
  ...
  // Get the NFT Collection we deployed using web3sdks+
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.h1}>web3sdks Community Rewards Example</h1>
        ...
        isLoading ? (
          ...
          <div className={`${styles.main} ${styles.spacerTop}`}>
            ...
            <div className={styles.nftPreview}>
              ...
              <p>{session.user.name}&apos;s web3sdks Discord Member NFT</p>
            </div>
          ...
          <div className={`${styles.main} ${styles.spacerTop}`}>
            ...
            <a
              ...
              href={`https://discord.com/invite/web3sdks`}
            >
              Join Server
            </a>
          </div>
